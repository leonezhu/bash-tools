...
#
# Usage:
#   dev <alias>     - Open directory in VS Code by alias
...
dev() {
  ...
  case "$cmd" in
    "")
      echo "Usage: dev <alias> | dev add <alias> <path> | dev rm <alias> | dev ls" >&2
      return 1
      ;;
    add)
      _add_alias "dir" "$2" "$3"
    ...
    ls|list)
      ...
      ;;
    help|--help|-h)
      echo "Open directory in VS Code with aliases"
      echo ""
      echo "Usage:"
      echo "  dev <alias>          - Open directory in VS Code"
