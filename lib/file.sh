...
#
# Usage:
#   file <alias>    - Open directory in Finder by alias
...
file() {
  ...
  case "$cmd" in
    "")
      echo "Usage: file <alias> | file add <alias> <path> | file rm <alias> | file ls" >&2
      return 1
      ;;
    add)
      _add_alias "dir" "$2" "$3"
    ...
    ls|list)
      ...
      ;;
    help|--help|-h)
      echo "Open directory in Finder with aliases"
      echo ""
      echo "Usage:"
      echo "  file <alias>         - Open directory in Finder"
